    ...
    <div className="bg-cyan-900 relative -mt-40 mb-10 ">
      ...
      >
        <h2 className="text-center text-3xl font-bold mb-8">
          <span className="text-cyan-500">Mind</span>-Mind vs. Traditional
          In-Office Therapy
        </h2>
        <div className="overflow-x-auto max-w-screen-xl mx-auto rounded-md">
          ...
          <p className="text-sm text-gray-400 mt-6">
            Note: Both services offer unique benefits tailored to different
            preferences and needs. Explore their platforms for more details.
          </p>
        </div>
          </div>
          <Testimonial />
