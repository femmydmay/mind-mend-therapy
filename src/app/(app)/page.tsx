      ...
      <section className="min-h-screen relative bg-secondary/10">
        ...
        <div className="flex flex-wrap max-w-6xl mx-auto gap-12 py-16">
          ...
          <div className="flex-1 space-y-6">
            ...
            <article className="text-base text-gray-500 dark:text-gray-400">
              Our advanced system is designed to ensure you receive the best
              care possible. Once you have completed your profile and shared
              your needs, our platform uses this information to match you with a
              licensed therapist who is best suited to help.
            </article>
          </div>
        </div>
        <div className="grid place-content-center">
        ...
        <div className="flex flex-wrap max-w-6xl mx-auto gap-12 py-16">
          ...
          <div className="flex-1 space-y-6">
            ...
            <article className="text-base text-gray-500 dark:text-gray-400">
              Embark on your path to improved well-being with the convenience
              and privacy of secure video sessions and messaging. Our platform
              ensures that connecting with your therapist is not only effective
              but also tailored to fit into your busy lifestyle.
            </article>
          </div>
        </div>
        <div className="grid place-content-center">
